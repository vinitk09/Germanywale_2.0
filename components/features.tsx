          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                coursefinder.ai, a cutting edge white labelled tech platform,
                offers unparalleled customization options for our partners. By
                seamlessly incorporating their company’s logo and brand colors
                throughout the entire platform, partners can create a truly
                personalized experience that resonates with their unique
                identity and strengthens their brand presence in the education
                landscape.
              </p>
            </article>
            <article>
