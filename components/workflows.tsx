        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-linear-to-r before:from-transparent before:to-indigo-200/50 after:h-px after:w-8 after:bg-linear-to-l after:from-transparent after:to-indigo-200/50">
              <span className="inline-flex bg-gradient-to-r from-[#E56D09] via-[#D83E13] to-[#D83E13] bg-clip-text text-transparent">
                What We Do{" "}
              </span>
            </div>
            ...
            <p className="text-lg text-indigo-200/65">
              Discover how we can help you achieve your dreams with our
              personalized support. From university applications to visa
              guidance, we provide all the essential services to make your
              study-abroad journey in Germany smooth and successful.
            </p>
          </div>
          {/* Spotlight items */}
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-white">
                    Unlock your potential with Germanywale - CV enhancement
                    experts for successful university applications
                  </p>
                </div>
              </div>
            </a>
